  ...
  const fetchProduct = async () => {
    try {
      ...
      product.variants.forEach((variant) => {
        ...
        colorsMap.set(variant.color, variant.colorHex || "#000000");
        stockMap[`${variant.size}-${variant.color}`] = variant.stock;
      });
              ...
              <div className="card p-6">
                <h2 className="font-display text-lg text-goddess-dark mb-4">
                  ...
                  <span className="text-sm font-normal text-goddess-gray ml-2">
                    ({totalVariants} variants, {totalStock} total stock)
                  </span>
                </h2>
